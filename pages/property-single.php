...
<div class="section">
       ...
       <div class="col-lg-7">
        <div class="img-property-slide-wrap">
          <div class="img-property-slide">
            <?php  for ($i = 1; $i <= 5 ; $i++) { ?>
              <img src=<?php echo $rs["path_" . $i]?> alt="Property Image" class="img-fluid" />
            <?php }?>
          </div>
        </div>
      </div>
  ...
  <div class="container" id="map_container">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2ApSLCEHJQ6NbQX-XwiUHwBJNbBxwgb8"></script>
    <script>
      let api = "AIzaSyD2ApSLCEHJQ6NbQX-XwiUHwBJNbBxwgb8" // api key
